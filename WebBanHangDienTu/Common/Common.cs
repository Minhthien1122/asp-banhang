...
namespace WebBanHangDienTu.Common
{
    public class Common
    {
        ...
        private static string EmailAdmin = ConfigurationManager.AppSettings["EmailAdmin"];
        ...
        public static bool SendMailAdmin(string name, string subject, string content,
            string toMail)
        {
            bool rs = false;
            try
            {
                ...
                MailAddress fromAddress = new MailAddress(EmailAdmin, name);
                message.From = fromAddress;
                message.To.Add(toMail);
                message.Subject = subject;
                message.IsBodyHtml = true;
